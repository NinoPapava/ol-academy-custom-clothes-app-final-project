...
const Blouse = ({ type, cancel, progress }) => {
  const [isSubmit, setIsSubmit] = LocalStorage('isSubmit', false, 10);
  const [sleeveLength, setSleeveLength] = LocalStorage('sleeveLengthKey', '', 10);
  ...
  const handleSubmit = (e) => {
    ...
    DataService.create(data)
      ...
      .catch((error) => {
        console.error('Error submitting Blouse:', error);
      });
  };
        ...
        <>
          <div className="container-body">
            ...
            <form>
              ...
              <button type="submit" className="btn btn-primary mt-2" onClick={handleSubmit}>Save</button>
            </form>
